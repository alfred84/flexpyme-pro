...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::categories::category_finish_add,
            commands::categories::category_finish_set_default,
            commands::categories::category_finish_delete,
            commands::categories::category_work_types_list,
            commands::categories::category_work_types_all,
            commands::categories::category_work_type_add,
            commands::categories::category_work_type_remove,
            commands::categories::category_formats_list,
            commands::categories::category_formats_all,
            commands::categories::category_format_add,
            commands::categories::category_format_remove,
            ...
            commands::invoices::invoices_update_payment_config,
            commands::invoices::invoices_update_production_status,
            commands::invoices::invoice_item_mark_listo,
            commands::invoices::invoice_mark_all_listo,
            ...
            commands::production::production_report_monthly,
            commands::production::production_report,
            ...
            commands::reports::export_operational_xlsx,
            ...
            commands::finishes::get_finishes,
            commands::finishes::create_finish,
            commands::finishes::update_finish,
            commands::finishes::deactivate_finish,
            commands::finishes::reactivate_finish,
            ...
            commands::employee_roles::employees_for_work_type,
            commands::employee_roles::employees_for_work_type_name,
            ...
            commands::other_expenses::other_expense_create,
            commands::other_expenses::other_expense_update,
            commands::other_expenses::other_expense_delete,
            commands::expense_types::expense_types_list,
            commands::expense_types::expense_type_create,
            commands::expense_types::expense_type_update,
            commands::expense_types::expense_type_deactivate,
            commands::expense_types::expense_type_reactivate,
            ...
            commands::inventory::inventory_movements_in_range,
            commands::inventory::inventory_consumption_summary,
            commands::inventory::inventory_consumption_in_range,
            ...
            commands::inventory::inventory_material_category_deactivate,
            commands::inventory::inventory_material_category_reactivate,
            commands::inventory::inventory_recipes_list,
            commands::inventory::inventory_recipe_create,
            commands::inventory::inventory_recipe_update,
            ...
            commands::cash_control::cash_day_opening_save
        ])
