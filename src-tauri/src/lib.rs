...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::categories::category_services_all,
            commands::categories::category_service_create,
            commands::categories::category_service_set_default,
            commands::categories::category_service_delete,
            commands::categories::category_finishes_all,
            commands::categories::category_finish_create,
            commands::categories::category_finish_set_default,
            commands::categories::category_finish_delete,
            commands::units::get_units,
            commands::units::create_unit,
            commands::units::update_unit,
            commands::units::deactivate_unit,
            commands::units::reactivate_unit,
            ...
            commands::formats::reactivate_format,
            ...
            commands::work_types::reactivate_work_type,
            commands::settings::settings_get_company,
            commands::settings::settings_save_company,
            commands::settings::settings_get_all,
            commands::settings::settings_set_value,
            commands::settings::settings_set_exchange_rate,
            commands::settings::settings_get_exchange_rate_history,
            ...
            commands::employee_roles::reactivate_employee_role,
            ...
            commands::employees::work_batches_for_invoice,
            ...
            commands::inventory::inventory_recipes_list,
            commands::inventory::inventory_recipe_create,
            commands::inventory::inventory_recipe_deactivate,
