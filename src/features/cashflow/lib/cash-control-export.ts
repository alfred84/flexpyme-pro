...
export function buildCashControlExportSections(params: {
  ...
  const sections: ReportTableSection[] = [
    ...
    },
    {
      ...
      aoa: [
        ["Métrica", "USD", "CUP"],
        ["Inicial", usd.openingTotal, cup.openingTotal],
        ["Entradas", usd.inTotal, cup.inTotal],
        ["Salidas", usd.outTotal, cup.outTotal],
        [estimadoLabel, usd.estimatedTotal, cup.estimatedTotal],
      ],
    },
